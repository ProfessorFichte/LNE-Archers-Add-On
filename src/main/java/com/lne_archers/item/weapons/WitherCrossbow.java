...
import com.lne_archers.entity.projectile.GlacialArrowEntity;
import com.lne_archers.entity.projectile.WitherArrowEntity;
...
public class WitherCrossbow extends CustomCrossbow {
    public WitherCrossbow(Item.Settings settings, Supplier<Ingredient> repairIngredientSupplier) {
    ...
    private static PersistentProjectileEntity createArrow(World world, LivingEntity entity, ItemStack crossbow, ItemStack arrow) {
        PersistentProjectileEntity persistentProjectileEntity = new WitherArrowEntity(world, entity);
